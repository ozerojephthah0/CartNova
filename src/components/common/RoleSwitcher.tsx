...
import { User, Store, ShieldCheck, Check, Sparkles, X, RefreshCw, LogIn, ShoppingBag } from 'lucide-react';
...
export const RoleSwitcher: React.FC<RoleSwitcherProps> = ({ isOpen, onClose }) => {
  const { activeRole, currentUser, allUsers, switchRole, resetStoreData, openAuthModal } = useStore();
        ...
        >
          ...
          <div className="px-6 py-3 bg-slate-100/70 border-t border-slate-200">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 block mb-2">
              Or Sign In With Custom Email & Credentials:
            </span>
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="flex items-center justify-center gap-1.5 px-3 py-2 bg-white hover:bg-indigo-50 border border-slate-200 hover:border-indigo-300 rounded-xl text-xs font-semibold text-slate-700 hover:text-indigo-700 transition-colors cursor-pointer shadow-2xs"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 px-3 py-2 bg-white hover:bg-purple-50 border border-slate-200 hover:border-purple-300 rounded-xl text-xs font-semibold text-slate-700 hover:text-purple-700 transition-colors cursor-pointer shadow-2xs"
              >
